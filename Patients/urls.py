...
urlpatterns += [
    ...
    path('reports/print/<int:pk>/', print_patient_report, name='print_patient_report'),
    path('diet/add/<int:pk>/', add_diet, name='add_diet'),
    path('diet/update/<int:pk>/', DietUpdate.as_view(), name='DietUpdate'),
    path('diet/print/<int:pk>/', print_diet, name='print_diet'),
    ...
    path('prescription/<int:pk>/print/', print_prescription, name='print_prescription'),
    ...
    path('lab_test/request/<int:pk>/print/', print_lab_test_request, name='print_lab_test_request'),
